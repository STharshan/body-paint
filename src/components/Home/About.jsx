...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Very appreciative of the fabulous work to my car by Jake and his dad! Car is now looking as good as new (after having very bad damage to door) & work done at a very reasonable price! 100% recommend and would be back in future if needed.",
    name: "Eve Hammond",
  },
